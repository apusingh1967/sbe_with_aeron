...
public final class OrderMessageEncoder
{
    ...
    public OrderMessageEncoder putCustomerNote(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 65534)
        {
    ...
    public OrderMessageEncoder putCustomerNote(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 65534)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
